...
public class InstituteEmailtoAdmin
{
...
msg.setSubject(" One SIG-Institute Registered On STBI Web Portal");
 msg.setContent("Hello Admin,<br><br>One New SIG Institute Registered On STBI-PORTAL.<BR><BR>TEAM<BR>SAMRUDDHI TEAM","text/html");
    try 
    {
