...
/**
 * Servlet implementation class SigMatchEmail
 */
//@WebServlet("/SigMatchEmail")
public class SigMatchEmail extends HttpServlet {
...
{  
 try 
    {  
	     pst=con.prepareStatement("select * from sigregi  where emailid=?");  
