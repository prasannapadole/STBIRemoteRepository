...
public class SigmailToadmin
	...
	public static  void sendEmail()
			...
			msg.setSubject(" One SIG Registered On STBI Web Portal");
			 msg.setContent("Hello Admin,<br><br>One New SIG Member Registered On STBI-PORTAL.<BR><BR>TEAM<BR>SAMRUDDHI TEAM","text/html");
		        try 
		        {
