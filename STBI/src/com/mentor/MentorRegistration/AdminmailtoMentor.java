...
public class AdminmailtoMentor
{
		...
		try
			{
				...
				msg.setSubject(" One Mentor Registered On STBI Web Portal");
				msg.setContent("Hello Admin,<br><br>One New Mentor Registered On STBI-PORTAL.<BR><BR>TEAM<BR>SAMRUDDHI TEAM","text/html");
				try 
					{
