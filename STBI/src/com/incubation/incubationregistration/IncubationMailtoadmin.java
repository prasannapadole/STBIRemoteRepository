...
public class IncubationMailtoadmin
{
...
msg.setSubject(" New  Sig Incubation Registered On STBI Web Portal");
 msg.setContent("Hello Admin,<br><br>One New Sig Incubation Registered On STBI-PORTAL.<BR><BR>TEAM<BR>SAMRUDDHI TEAM","text/html");
    try 
    {
