...
/**
 * Servlet implementation class IncubationMatchEmail
 */
//@WebServlet("/IncubationMatchEmail")
public class IncubationMatchEmail extends HttpServlet {
	...
	{  
	 try 
	    {  
		     pst=con.prepareStatement("select * from incubationregi  where emailid=?");  
