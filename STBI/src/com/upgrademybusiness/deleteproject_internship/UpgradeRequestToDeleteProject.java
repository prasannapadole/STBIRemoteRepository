...
/**
 * Servlet implementation class UpgradeRequestToDeleteProject
 */
//@WebServlet("/UpgradeRequestToDeleteProject")
public class UpgradeRequestToDeleteProject extends HttpServlet {
...
public void init(ServletConfig config) throws ServletException
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		query="update upgrademybusinessprojectinfo set projectdeletedesc=? where projectId=?";
