...
public class UpgrademyBusinessloginDao
{
	public static boolean checkUser(String email,String password)  //call a static checkUser mentod with three urgument 
	{
     ...
     try{
    	 ...
    	 pst =con.prepareStatement("select emailid,password,registrationstatus from upgrademybusiness where emailid=? and password=?");//fire a query
