...
public class Mailtoadmin_BusinessUpgrade
{
...
msg.setSubject(" One Upgrade My Business Registered On STBI Web Portal");
 msg.setContent("Hello Admin,<br><br>One New Upgrade My Business Registered On STBI-PORTAL.<BR><BR>TEAM<BR>SAMRUDDHI TEAM","text/html");
    try 
    {
