...
/**
 * Servlet implementation class UpgradeBusinessMatchEmail
 */
//@WebServlet("/UpgradeBusinessMatchEmail")
public class UpgradeBusinessMatchEmail extends HttpServlet {
		...
		String email=request.getParameter("email");
		      if(email.contains("@")&&email.contains("."))//validation of email
		        {  
		         try 
		            {  
					     pst=con.prepareStatement("select * from upgrademybusiness  where emailid=?");  
