...
<html ng-app="sigDashboard" ng-controller="sigctrldashboard">
	 <head>
	    <title>SIG Project Details</title>
	    <meta charset="utf-8">
						...
						<div class="panel panel-default panels">
							<div class="panel-body">
								...
								<div class="fload_right">
							        <a button class="btn btn-warning active" href="ProjectApplyStatus?projectId=<%=dbprojectid%>">Apply</a></button>
								    <a button class="btn btn-info btn-md active" href="sig-dashboard.jsp">Back</a></button>
								</div>
