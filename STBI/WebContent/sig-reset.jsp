...
<title>SIG Reset Password</title>
...
<%  
 //create object
      ...
      //get values 
	    ...
	    {
        String query="select * from sigregi where uuidnumber=?";
     ...
     if(uuid.equals(dbuid) && (edbemailstatus.equalsIgnoreCase("Unhit")) && diffmin>=0)
        	 ...
        	 String query1="update sigregi set emailstatus=? where uuidnumber=?";
        ...
        <form action="./SigResetPass" method="post">
