...
<title>Incubation Reset Password</title>\
...
<%  
 //create object
      ...
      //get values 
	    ...
	    {
        String query="select * from incubationregi where uuidnumber=?";
     ...
     if(uuid.equals(dbuid) && (edbemailstatus.equalsIgnoreCase("Unhit")) && diffmin>=0)
        	 ...
        	 String query1="update incubationregi set emailstatus=? where uuidnumber=?";
        ...
        <form action="./IncubationResetPassword" method="post">
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
          <h1 class="text-center">Incubation Reset</h1>
        </div>
         <div class="modal-body">
           <div class="form-group">
             ...
             <div class="form-group">
                 ...
                 <span class="pull-right"><a href="sig-login.jsp">New User Register</a></span><span><a href="sig-login.jsp">Login</a></span>
             </div>
         </div>
    </div>
 </div>
