...
<html ng-app="scaleupDashboard" ng-controller="scaleupctrldashboard">
	<head>
	    <title>Scaleup Internship Response</title>
	    <meta charset="utf-8">
		...
		<div class="container">
			<div class="top">
				...
				<table class="table table-hover">
				    ...
				    <%
				    long internshipid=Long.parseLong(request.getParameter("dbinternsId"));
				    //String query1="select sigId from sig_appliedfor_internship where internshipId=?";
				  ...
				  //  while(rs1.next())
				  //  {
				    //dbsigid=rs1.getLong(1);
				    String query2=" select sigregi.siggroupname,sigregi.groupleadername,sigregi.siggrouptype,sigregi.mobilenumber,sigregi.emailid from sig_appliedfor_internship,sigregi where sigregi.sigId=sig_appliedfor_internship.sigId and sig_appliedfor_internship.internshipId=?";
				    pst2=con.prepareStatement(query2);
				    pst2.setLong(1,internshipid);
				   ...
				   <%-- 
				    ...
				    String query2=" select sigregi.siggroupname,sigregi.groupleadername,sigregi.siggrouptype,sigregi.mobilenumber,sigregi.emailid from sig_appliedfor_internship,sigregi where sigregi.sigId=sig_appliedfor_internship.sigId and sig_appliedfor_internship.sigId=?";
				    pst2=con.prepareStatement(query2);
				    pst2.setLong(1,dbsigid);
				    rs2=pst2.executeQuery();
				    String dbsiggroupname="",dbgroupleadername="",dbsiggrouptype="", dbmobilenumber="",dbemailid="";
				    while(rs2.next())
				    {
