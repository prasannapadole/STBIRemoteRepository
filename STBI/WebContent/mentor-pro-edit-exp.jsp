    ...
    %>
	  ...
	  // rd.forward(request,response);
	   ...
	   <nav class="navbar navbar-fixed-top ">
		...
		String query2="select * from mentorexperience where mentorexpId=?";
		pst2=con.prepareStatement(query2);
		pst2.setLong(1,mentorexpid);
		rs2=pst2.executeQuery();
		long dbmentorexpId=0;
		String dbdesignation="",dbcompanyname="",dblocation="",dbfromda="",dbtoda="",dbdescription="";
		while(rs2.next())
		{
			dbmentorexpId=rs2.getLong("mentorexpId");
			dbdesignation=rs2.getString("designation");
			dbcompanyname=rs2.getString("companyname");
			dblocation=rs2.getString("location");
		...
		%>
		 <div style="padding: 30px;">
		 	<form name="profForm" action="./MentorEditExperience" method="post" style="margin-top: 100px;">
					  <div class="form-group">
					    <label for="inputsm">Designation</label>
					    <input class="form-control input-sm" id="inputsm" type="text" name="designation" value="<%=dbdesignation %>" ng-model="designation" required>
					 <input type="hidden" name="mentorexpid" value="<%=dbmentorexpId %>" />
					  </div>
					 <div class="form-group">
					    <label for="inputsm">Company Name</label>
					    <input class="form-control input-sm" id="inputsm" type="text" name="cname" value="<%=dbcompanyname %>" ng-model="cname" required/>
					  </div>
					 <div class="form-group">
					    <label for="inputsm">Location</label>
					    <input class="form-control input-sm" id="inputsm" type="text" name="location" value="<%=dblocation %>" ng-model="location" required/>
					  </div>
