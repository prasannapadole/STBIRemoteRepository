...
<html ng-app="sigDashboard" ng-controller="sigctrldashboard">
 <head>
	    <title>Institute Project Update Progress </title>
	    <meta charset="utf-8">
   ...
   %>
	...
	<nav class="navbar navbar-fixed-top ">
		...
		<div class="containers top">
			  <form name="milestoneForm" action="./Institute_Project_upgradeProcess" method="post">
				    <div class="panel panel-default panels card">
				       <h3 class="text-center">Update Progress</h3>
				    	<div class="panel-body">
							 ...
							 <%
							   String query1="select * from institute_project_upgrade_process where instituteId=?";
							   pst1=con.prepareStatement(query1);
							   pst1.setLong(1,dbinstituteid);
							   rs1=pst1.executeQuery();
							   long dbinstituteprojectupgradeId=0;
							   String dbcurrentdate="",dbmilestonename="",dbmilestonetype="",dbmilestonedescription="";
							   while(rs1.next())
							   {
								   dbinstituteprojectupgradeId=rs1.getLong("instituteprojectupgradeId");
