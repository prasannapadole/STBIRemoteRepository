              ...
              <div class="panel-body">
                <div class="text-center">
                  ...
                  <div class="panel-body">
                    ...
                    <form id="register-form" role="form" autocomplete="off" class="form" action="MentorForgotpass" method="post">
                      ...
                      <div class="form-group">
                        <input name="recover-submit" class="btn btn-md btn-info active btn-block" value="Send Verification Link" type="submit" onclick="return "><br>
                         <span class="pull-right"><a href="mentor-login.jsp">New User Register</a></span><span class="pull-left"><a href="mentor-login.jsp">Login</a></span>
                      </div>
