...
<html ng-app="sigDashboard" ng-controller="sigctrldashboard">
 <head>
	    <title>Incubation Internship Update Progress </title>
	    <meta charset="utf-8">
   ...
   while(rs.next())
	...
	%>
		...
		<div class="containers top">
			 <form name="milestoneForm" action="./Incubation_Internship_upgradeProcess" method="post">
				       ...
				       <h3 class="text-center">Update Progress</h3>
				    	<div class="panel-body">
				    	     <div class="container">
							   ...
							   <%
							   String query1="select * from incubation_internship_upgrade_process where incubationId=?";
							   pst1=con.prepareStatement(query1);
							   pst1.setLong(1,dbincubutionid);
							   rs1=pst1.executeQuery();
							   long dbincubationinternshipupgradeId=0;
							   String dbcurrentdate="",dbmilestonename="",dbmilestonetype="",dbmilestonedescription="";
							   while(rs1.next())
							   {
								   dbincubationinternshipupgradeId=rs1.getLong("incubationinternshipupgradeId");
