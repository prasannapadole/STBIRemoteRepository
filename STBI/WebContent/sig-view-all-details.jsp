<%@page import="com.sig.sig.view.all.details.SigViewAllDetails"%>
...
<html ng-app="sigDashboard" ng-controller="sigctrldashboard">
	 <head>
	    <title>SIG View All Details</title>
	    <meta charset="utf-8">
					...
					<div class="panel-body">
						<div class="panel panel-default panels">
							<div class="panel-body">
								...
								if(SigViewAllDetails.checkUser(ideaid))
								{
								     ...
								     while(rs3.next())
								     {
								    	 ...
								    	 if(dbdbideaupdateprogressideaid==dbideaid)
								    	 {	 %>
							...
							<!---------------------------------------------------------------------------------------------------------->
								...
								<div>
									<a class="btn btn-info btn-md active fload_right" href="sig-dashboard.jsp">Back</a>
								</div>
							</div>
						</div>
					</div>
