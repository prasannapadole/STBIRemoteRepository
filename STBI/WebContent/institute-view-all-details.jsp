<%@page import="com.institute.institute.view.all.details.InstituteViewAll"%>
...
<html  ng-app="sigDashboard" ng-controller="sigctrldashboard">
	 <head>
	    <title>Institute View All Details</title>
	    <meta charset="utf-8">
					...
					<div class="panel-body">
						<div class="panel panel-default panels">
							<div class="panel-body">
								...
								<%
								if(InstituteViewAll.checkUser(dbideaid))
								{
								...
								<div>
									<a class="btn btn-info btn-md active fload_right" href="institute-dashboard.jsp">Back</a>
								</div>
							</div>
						</div>
					</div>
