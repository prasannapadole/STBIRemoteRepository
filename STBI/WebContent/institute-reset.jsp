...
<title>Institute Reset Password</title>
...
<%  
 //create object
      ...
      //get values 
	    ...
	    {
        String query="select * from instituteregi where uuidnumber=?";
     ...
     if(uuid.equals(dbuid) && (edbemailstatus.equalsIgnoreCase("Unhit")) && diffmin>=0)
        	 ...
        	 String query1="update instituteregi set emailstatus=? where uuidnumber=?";
        ...
        <form action="./InstituteResetPassword" method="post">
