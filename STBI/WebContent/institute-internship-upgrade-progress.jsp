...
<html ng-app="sigDashboard" ng-controller="sigctrldashboard">
 <head>
	    <title>Institute Internship Update Progress </title>
	    <meta charset="utf-8">
   ...
   %>
	...
	<nav class="navbar navbar-fixed-top ">
		...
		<div class="containers top">
			  <form name="milestoneForm" action="./Institute_Internship_upgradeProcess" method="post">
				                	...
				                	<div class="panel-body">
							           ...
							           <div>
							            ...
							            <div class="fload_right">
							            	<a button class="btn btn-info btn-md active" href="institute-dashboard.jsp">Back</a>
							           		<button class="btn btn-info btn-md active">Upload</button>
							            </div>
							       </div>
							   </div>
						   <%
							   String query1="select * from institute_internship_upgradeprogress where instituteId=?";
							   pst1=con.prepareStatement(query1);
							   pst1.setLong(1,dbinstituteid);
							   rs1=pst1.executeQuery();
							   long dbinstituteinternshipupgradeId=0;
							   String dbcurrentdate="",dbmilestonename="",dbmilestonetype="",dbmilestonedescription="";
							   while(rs1.next())
							   {
								   dbinstituteinternshipupgradeId=rs1.getLong("instituteinternshipupgradeId");
