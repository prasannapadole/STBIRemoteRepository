...
<%!
    ...
    // rd.forward(request,response);
	  ...
	  %>
        ...
        <%
		long sigupdateprogressId=Long.parseLong(request.getParameter("ideaupdateprogressId"));
		%>	
            <form action="" method="post" style="margin-top: 100px;">
		 	 <div style="padding: 30px;" >
				 ...
				 <textarea class="form-control input-md" id="inputsm" rows=" " cols="" name="reason" placeholder="Reason To Delete Update Progress" required></textarea>
					  ...
					  <div><input type="hidden" name="sigupdateprogressId" value="<%=sigupdateprogressId %>"/> </div>
