...
<html  ng-app="sigDashboard" ng-controller="sigctrldashboard">
 <head>
	    <title>SIG Internship Update Progress </title>
	    <meta charset="utf-8">
    ...
    // rd.forward(request,response);
	  ...
	  %>
		...
		<div class="containers top">
			  <form name="milestoneForm" action="./Sig_Internship_upgradeProcess" method="post">
				       ...
				       <h3 class="text-center">Update Progress</h3>
				    	<div class="panel-body">
				    	     <div class="container">
							   ...
							   <%
							   String query1="select * from sig_upgradeprogress where sigId=?";
							   pst1=con.prepareStatement(query1);
							   pst1.setLong(1,sigid);
							   rs1=pst1.executeQuery();
							   long dbsigupgradeprogressId=0;
							   String dbcurrentdate="",dbmilestonename="",dbmilestonetype="",dbmilestonedescription="";
							   while(rs1.next())
							   {
								   dbsigupgradeprogressId=rs1.getLong("sigupgradeprogressId");
