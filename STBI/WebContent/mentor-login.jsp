							   		 ...
							   		 <div class="panel  panel-border ">
							   		   <div class="panel-body">
									        <form action="./Mentorlogin" method="post">  
												  ...
												  <div class="fload_right">
												    	<a href="mentorforgotpass.jsp" target="_blank" >Forget Password</a>
												  </div>
											</form> 
									    </div>
							        </div>
			          ...
			          <div class="panel panel-default panel-top-border card">
			        	   <div class="panel-body">
						        <div class="registration-center ">
							    	 <div class="panel   panel-border">
								   		   <div class="panel-body">
								   		   		 <form class="form-horizontal" name="myForm" action="./MentorRegistration" method="post">
													  ...
													  <div class="form-group ">
													   ...
													   <div class="form-group ">
														    <label class="col-sm-3 control-label">Area of Support</label>
														    <div class="col-sm-8  has-feedback">
														    	<select class="form-control" ng-model="supports" name="supports" required/>
													  ...
													  <!-- ------------------------------------ -->
													   ...
													   <div class="form-group">
														    ...
														    <div class="col-sm-8 has-feedback">
														      <input class="form-control" id="focusedInput" type="text" value="" name="email"  ng-model="email" ng-pattern="emailid" onkeyup="sendInfo2();" onmouseenter="sendInfo2();" required/>
