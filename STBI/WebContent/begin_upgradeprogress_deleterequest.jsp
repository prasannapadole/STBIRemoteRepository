...
<title>Delete Update Progress</title>
...
<form action="./RequestToDeleteUpdateProgress" method="post" style="margin-top: 100px;">
		 	 <div style="padding: 30px;" >
				 <div class="form-group">
				    <label for="inputsm">Reason To Delete Update Progress</label>
				 <textarea class="form-control input-md" id="inputsm" rows=" " cols="" name="reason" placeholder="Reason To Delete Update Progress" required></textarea>
					  </div>
					  <div><input type="hidden" name="ideaupdateprogressId" value="<%=ideaupdateprogressId %>"/> </div>
