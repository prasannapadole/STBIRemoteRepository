...
<html  ng-app="sigDashboard" ng-controller="sigctrldashboard">
 <head>
	    <title>SIG Project Update Progress </title>
	    <meta charset="utf-8">
    ...
    // rd.forward(request,response);
	  ...
	  %>
		...
		<div class="containers top">
			  <form name="milestoneForm" action="./Sig_project_UpgradeProcess" method="post">
				                	...
				                	<div class="panel-body">
							           ...
							           <div>
							            ...
							            <div class="fload_right">
							                <button class="btn btn-warning active">Upload</button>
							            	<a button class="btn btn-info btn-md active" href="sig-dashboard.jsp">Back</a>
							           		
							            </div>
							       </div>
							   </div>
							  <%
							   String query1="select * from sig_project_upgrade_progress where sigId=?";
							   pst1=con.prepareStatement(query1);
							   pst1.setLong(1,sigid);
							   rs1=pst1.executeQuery();
							   long dbsigprojectupgradeId=0;
							   String dbcurrentdate="",dbmilestonename="",dbmilestonetype="",dbmilestonedescription="";
							   while(rs1.next())
							   {
								   dbsigprojectupgradeId=rs1.getLong("sigprojectupgradeId");
