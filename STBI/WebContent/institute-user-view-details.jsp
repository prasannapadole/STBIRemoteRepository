...
<html  ng-app="instiDashboard" ng-controller="instictrldashboard">
 <head>
	    <title>Institute View Idea</title>
	    <meta charset="utf-8">
			      ...
			      <div class="panel-heading">
			        <h4 class="panel-title">
			          ...
			          <a data-toggle="collapse" href="#collapse1" class="idea-id"><%=dbstatusofidea %></a>
			            <a  href="institute-dashboard.jsp" class="idea-id" style="color:navy" >Back</a>
			        </h4>
			      </div>
