...
String email=request.getParameter("email");
	    ...
	    {
        String query="select * from upgrademybusiness where uuidnumber=?";
     ...
     if(uuid.equals(dbuid) && (edbemailstatus.equalsIgnoreCase("Unhit")) && diffmin>=0)
        	 ...
        	 String query1="update upgrademybusiness set emailstatus=? where uuidnumber=?";
        ...
        <form action="./UpgradeMybusinessResetPass" method="post">
         ...
         <div class="modal-body">
           <div class="form-group">
             ...
             <div class="form-group">
                 ...
                 <span class="pull-right"><a href=scaleup-login.jsp">New User Register</a></span><span><a href="scaleup-login.jsp">Login</a></span>
             </div>
         </div>
    </div>
 </div>
