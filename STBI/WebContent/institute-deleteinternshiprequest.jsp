...
<title>Delete Institute Internship</title>
   ...
   <%
     ...
     while(rs.next())
      ...
      <%
	   ...
	   %>
<form action="./Institute_RequestDeleteInternship" method="post" style="margin-top: 100px;">
		 <div style="padding: 30px;" >
				 ...
				 <textarea class="form-control input-md" id="inputsm" rows=" " cols="" name="reason" placeholder="Reason to Delete Internship" required></textarea>
					  ...
					  <div><input type="hidden" name="internsId" value="<%=internsId %>"/> </div>
