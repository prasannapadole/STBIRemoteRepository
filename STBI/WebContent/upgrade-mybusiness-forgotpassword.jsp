...
<title>Upgrade My Business Forgot Password</title>
...
<body>
<form id="register-form" role="form" autocomplete="off" class="form"  action="./MyBusinessForgotpass" method="post">
                  ...
                  <div class="panel-body">
                      ...
                      <div class="form-group">
                        <input name="recover-submit" class="btn btn-md btn-info active btn-block" value="Send Verification Link" type="submit" onclick="return "><br>
                         <span class="pull-right"><a href="scaleup-login.jsp">New User Register</a></span><span class="pull-left"><a href="scaleup-login.jsp">Login</a></span>
                      </div>
